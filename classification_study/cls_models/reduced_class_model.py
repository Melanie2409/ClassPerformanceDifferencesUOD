## Classification Model for Class-Specific Reduced Datasets
...
BASE_PATH = os.path.join(project_root, "cls_datasets", "one_class_reduced")
CHECKPOINTS_PATH = os.path.join(project_root, "cls_models", "one_class_reduced_checkpoints")
RESULTS_PATH = os.path.join(project_root, "cls_results", "one_class_reduced_results")
