## Classification Model for Imbalanced Datasets
...
CHECKPOINTS_PATH = os.path.join(project_root, "cls_models", "imbalanced_checkpoints")
RESULTS_PATH = os.path.join(project_root, "cls_results", "imbalanced_results")
