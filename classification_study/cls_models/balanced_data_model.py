## Classification Model for Balanced Datasets
...
BASE_PATH = os.path.join(project_root, "cls_datasets", "balanced_data")
CHECKPOINTS_PATH = os.path.join(project_root, "cls_models", "balanced_checkpoints")
RESULTS_PATH = os.path.join(project_root, "cls_results", "balanced_results")
