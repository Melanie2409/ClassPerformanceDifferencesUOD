## Classification Model for weighted-sampling
...
BASE_PATH = os.path.join(project_root, "cls_datasets", "imbalanced_data")
CHECKPOINTS_PATH = os.path.join(project_root, "cls_models", "weighted_sampling_checkpoints")
RESULTS_PATH = os.path.join(project_root, "cls_results", "weighted_sampling_results")
