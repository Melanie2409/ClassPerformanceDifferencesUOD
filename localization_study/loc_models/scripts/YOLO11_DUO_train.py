...
if __name__ == "__main__":
    ...
    # Classes for single_class_DUO training
    CLASS_LIST = ["echinus", "holothurian", "scallop", "limited_scallop", "starfish"]
    ...
    for class_name in CLASS_LIST:
        ...
        epoch_number = 30
        run_number = "01"
        run_name = f"{class_name}_train_run_{run_number}"
        project_name = "yolo11-train-single-class-DUO"
