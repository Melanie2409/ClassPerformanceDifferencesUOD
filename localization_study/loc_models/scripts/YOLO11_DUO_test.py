...
if __name__ == "__main__":
    ...
    BASE_PATH = os.path.join(project_root, "loc_datasets", "single_class_DUO")
    ...
    for class_name in CLASS_LIST:
        ...
        run_number = "01"
        run_name = f"25conf_single_class_DUO_{class_name}_test_run_{run_number}"    # We test with confidence threshold 0.25
        project_name = "yolo11-test-single-class-DUO"
        ...
        # Test saved model
        model_path = os.path.join(f"{CHECKPOINT_PATH}/yolo11-train-single-class-DUO/{class_name}_train_run_{run_number}/weights/best.pt")
